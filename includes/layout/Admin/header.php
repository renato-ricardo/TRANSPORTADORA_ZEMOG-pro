...
<div class="loader">
  <img src="assent/img/35.gif" alt="Loading...">
</div>
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              ...
              <li class="dropdown-submenu dropdown-hover">
                ...
                <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                  <li>
                  <a tabindex="-1" href="unidades.php" class="dropdown-item">Relaci&oacute;n de Unidad</a>
                  </li>         
                  <!-- End Level three -->
                  <li><a href="talleres.php" class="dropdown-item">Talleres</a></li>
                   <li><a href="estatus.php" class="dropdown-item">Estatus</a></li>
              ...
              <!-- Level two dropdown-->
              <li class="dropdown-submenu dropdown-hover disabled">
                <a id="dropdownSubMenu2" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-item dropdown-toggle">Viáticos</a>
                <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">       
                  <!-- End Level three -->
        ...
        <ul class="navbar-nav">
          <li class="nav-item dropdown ">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              <li><a href="usuarios.php" class="dropdown-item">Agregar Usuarios</a></li>
              <li><a href="categorias.php" class="dropdown-item">Agregar Categorías</a></li>
              <li><a href="sucursal.php" class="dropdown-item">Agregar Sucursales</a></li>
              <li><a href="operaciones.php" class="dropdown-item">Agregar Operación</a></li>
              <li><a href="marcaUnidades.php" class="dropdown-item">Agregar Marca de Unidades</a></li>
              <li><a href="estatus_disponibles.php" class="dropdown-item">Agregar Estatus de unidad</a></li>
               </ul>
          </li>
        </ul>
      </div>
